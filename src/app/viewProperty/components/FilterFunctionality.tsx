...
const FilterFunctionality = ({
  ...
  const bhkOptions = Array.from(new Set(propertyData.map((p) => p.bedrooms))).sort();
      ...
      <div className="w-1/4 p-4">
        ...
        <div>
          <Button
            ...
            className="w-full px-4 py-2 bg-blue-500 text-white rounded-full hover:bg-black"
          >
            Clear Filters
          </Button>
        </div>
